...
class AppColors {
  ...
  static const Color backgroundHomePageLight = Color(0xfff2f2f8);
  ...
  static const Color hintLight = Color(0xff686874);
  static const Color hintDark = Color.fromARGB(255, 220, 220, 235);
  ...
  // Accent Colors
  static const Color cardDark = Color(0xff393e4b);
  static const Color cardImageBg = Color(0xfff6f5f1);
  static const Color lightRed = Color.fromARGB(255, 251, 196, 192);
