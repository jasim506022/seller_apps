...
class ThemeUtils {
  ...
  static Color? get bottomTotalBill =>
      getTheme ? AppColors.cardDark : AppColors.green.withOpacity(.1);
  ...
  static Color? get categorySelectBackground =>
      getTheme ? AppColors.green : AppColors.black;

  static Color? get backgroundCutilsolor =>
      getTheme ? AppColors.backgroundDark : const Color(0xfff2f2f8);
}
*/
